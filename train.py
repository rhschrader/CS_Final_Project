...
if resume:
    ...
    Q = QNetwork(env.action_space, input_shape, alpha, gamma, name = 'Q', resume=False)
    Q_target = QNetwork(env.action_space, input_shape, alpha, gamma, name='Q_target', resume=False)
